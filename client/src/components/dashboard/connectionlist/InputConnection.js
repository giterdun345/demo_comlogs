        ...
        <div className="m-auto w-100">
          <div className="card text-center shadow-lg">
            <div className="card-body">
              <h2 style={{color: 'red'}}>There is no db connected for the demo.</h2>
                <form className="mt-5" onSubmit={onSubmitForm}>
                  ...
                  <select  type="text" name="school" placeholder="School" className="form-control mt-3" defaultValue={defaultSchool} value={defaultSchool} onChange={e => setSchool(e.target.value)}>
                        <option value="OtHER" disabled>Choose your school</option>
                  ...
                  {/* BUTTON  */}
                  <button className="btn btn-success btn-block mt-3 mb-5" style={{fontSize:"20px", color: "white", border: "2px solid rgba(103, 192, 103, 0.75)", borderRadius:"50px", transition: "all 0.3s ease 0s"}}>Add</button>
                </form>
            </div> 
          </div> 
        </div>
